...
[![GoDoc](https://godoc.org/matching_engine/sarama-cluster?status.svg)](https://godoc.org/matching_engine/sarama-cluster)
[![Build Status](https://travis-ci.org/bsm/sarama-cluster.svg?branch=master)](https://travis-ci.org/bsm/sarama-cluster)
[![Go Report Card](https://goreportcard.com/badge/matching_engine/sarama-cluster)](https://goreportcard.com/report/matching_engine/sarama-cluster)
...
Documentation and example are available via godoc at http://godoc.org/matching_engine/sarama-cluster
...
import (
	...
	cluster "matching_engine/sarama-cluster"
)
